<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_appointment');?>');" 
    ...
    <tbody>
        <?php foreach ($appointment_info as $row) { ?>   
            <tr>
                ...
                <td>
                    <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_appointment/'.$row['appointment_id']);?>');" 
                        class="btn btn-info btn-sm">
                            <i class="fa fa-pencil"></i>&nbsp;
                        <?php echo get_phrase('edit');?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('doctor/appointment/delete/'.$row['appointment_id']); ?>')"
