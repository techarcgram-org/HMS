<div class="sidebar-menu">
    ...
    <div class="sidebar-user-info">
        ...
        <div class="sui-hover inline-links animate-in"><!-- You can remove "inline-links" class to make links appear vertically, class "animate-in" will make A elements animateable when click on user profile -->				
            <a href="<?php echo site_url('doctor/manage_profile');?>">
    ...
    <ul id="main-menu" class="">
            ...
            echo 'opened active';?> ">
                ...
                <ul>
                    ...
                    <li class="<?php if ($page_name == 'manage_requested_appointment') echo 'active'; ?> ">
                        <a href="<?php echo site_url('doctor/appointment_requested');?>">
                            <i class="entypo-dot"></i>
        ...
        <li class="<?php if ($page_name == 'payroll_list') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/payroll_list');?>">
        ...
        <li class="<?php if ($page_name == 'message') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/message');?>">
